...
def problem2_2(my_list):
   print(my_list)
    ...
    print(len(my_list))
    my_list.append("z")
    print(my_list)  pass # replace this pass (a do-nothing) statement with your code
...
def problem2_3(country):
    for states in range (0,len(country)):
        print(country[states]," has ",len(country[states])," letters.")
