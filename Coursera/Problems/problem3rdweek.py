# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 21:16:04 2020
...
def problem3_1(txtfilename):
    ...
    for line in file:
        ...
        print(line,end="")
    print("\n\nThere are",charct ,"letters in the file.")
    file.close
...
def problem3_3(month, day, year):
    ...
    monthnum = int(month)
    str_month = months[monthnum-1]
    daystr = str(day)
    print(str_month,daystr+",",year)
...
def problem3_5(name):
    ...
    number = phone_numbers[name_lower]
    print(number)
#%%
"""
Problem 3_6:
